...
// MP4 modified: by implementing indirect addressing, we can have larger MaxFileSize
// MaxFileSizeL1: 32 * 128 = 4 KB
// MaxFileSizeL2: 32 * 32 * 128 = 128 KB
// MaxFileSizeL3: 32 * 32 * 32 * 128 = 4 MB
// MaxFileSizeL4: 32 * 32 * 32 * 32 * 128 = 128 MB
#define MaxFileSizeL1	(NumDirect * SectorSize)
#define MaxFileSizeL2	(NumDirect * NumDirect * SectorSize)
#define MaxFileSizeL3	(NumDirect * NumDirect * NumDirect * SectorSize)
#define MaxFileSizeL4	(NumDirect * NumDirect * NumDirect * NumDirect * SectorSize)
